...
/* Definitions for binarySemAnalog */
osSemaphoreId_t binarySemAnalogHandle;
const osSemaphoreAttr_t binarySemAnalog_attributes = {
  .name = "binarySemAnalog"
};
/* USER CODE BEGIN PV */
